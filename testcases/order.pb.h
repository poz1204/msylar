...
// string name = 2;
inline void makeOrderRequest::clear_name() {
  name_.ClearToEmpty();
}
inline const std::string& makeOrderRequest::name() const {
  // @@protoc_insertion_point(field_get:makeOrderRequest.name)
  return _internal_name();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void makeOrderRequest::set_name(ArgT0&& arg0, ArgT... args) {
 
 name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:makeOrderRequest.name)
}
inline std::string* makeOrderRequest::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:makeOrderRequest.name)
  return _s;
}
inline const std::string& makeOrderRequest::_internal_name() const {
  return name_.Get();
}
inline void makeOrderRequest::_internal_set_name(const std::string& value) {
  
  name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* makeOrderRequest::_internal_mutable_name() {
  
  return name_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* makeOrderRequest::release_name() {
  // @@protoc_insertion_point(field_release:makeOrderRequest.name)
  return name_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void makeOrderRequest::set_allocated_name(std::string* name) {
  if (name != nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:makeOrderRequest.name)
}
